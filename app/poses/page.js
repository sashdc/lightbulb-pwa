  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 ">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-screen-lg ">
        <Tile imageUrl="/images/wedding.webp" title="WEDDING" />

        <Tile imageUrl="/images/engagement.webp" title="ENGAGEMENT" />

        <Tile imageUrl="/images/family.webp" title="FAMILY" />

        <Tile imageUrl="/images/boudoir.webp" title="BOUDOIR" />
      </div>
